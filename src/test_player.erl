...
-export([init/4,start/1,start_1/2,start_3/1,enable_log/0,test1/1,test2/1,test1/0,test2/0]).
...
test1([Num]) ->
    run_tests(fun () -> start(list_to_integer(Num)) end).

test2([Num]) ->
    run_tests(fun () -> start_3(list_to_integer(Num)) end).
